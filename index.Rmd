...
In the current political atmosphere, a hot topic has been universal healthcare access.  However, too often the discussion leaves out the substantial role that income plays in shaping one's health outcomes and associated behaviors.  This analysis aims to investigate the role of income inequality in such outcomes and health behaviors to further understand the what particular health problems plague the poor and why.  By doing this, we hope to create a policy framework which may help improve the health outcomes and  behaviors of the lowest income people that will be most impactful.  The visualization above shows a preliminary overview of such health outcomes in New England. 
